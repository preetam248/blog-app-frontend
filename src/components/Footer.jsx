...
const Footer = () => {
  return (
    <>
      <div className="flex flex-col px-5 py-12 md:flex-row items-center justify-between">
        {/* first div */}
      ...
      <div className="flex flex-col px-5 sm:flex-row justify-between items-center my-6">
        <div className="flex  gap-2 items-center justify-center">
          ...
          />
          <p>
            Draftly <span className="font-bold text-xl">Blog</span>{" "}
          </p>
        </div>
        <ul className="flex flex-col sm:flex-row items-center  gap-3">
          <li>Privacy Policy</li>
          <li>Terms and conditions</li>
          <li> copyright @preetam </li>
        </ul>
      </div>
    </>
  );
